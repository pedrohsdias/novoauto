...
export class CriaTabelasIniciais1738904049110 implements MigrationInterface {
    name = 'CriaTabelasIniciais1738904049110'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."clientes_tipo_cliente_enum" AS ENUM('AUTONOMO', 'EMPRESA_ECV', 'EMPRESA_MATRZ', 'EMPRESA_FILIAL')`);
        await queryRunner.query(`CREATE TABLE "clientes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "apelido" character varying(150) NOT NULL, "tipo_cliente" "public"."clientes_tipo_cliente_enum" NOT NULL DEFAULT 'EMPRESA_ECV', "link_logo" character varying(200), "termo_data_aceite" TIMESTAMP, "termo_usuario_id" character varying, "pessoa_id" uuid NOT NULL, "matriz_id" uuid, CONSTRAINT "PK_d76bf3571d906e4e86470482c08" PRIMARY KEY ("id")); COMMENT ON COLUMN "clientes"."apelido" IS 'nome para exibição em tela, é o msm valor do homônimo em pessoa'`);
        await queryRunner.query(`CREATE TYPE "public"."servicos_tipo_servico_enum" AS ENUM('VISTORIA', 'CONSULTA')`);
        await queryRunner.query(`CREATE TYPE "public"."servicos_integracao_enum" AS ENUM('SEM_INTEGRACAO', 'CAUTELAR')`);
        await queryRunner.query(`CREATE TABLE "servicos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "nome" character varying(150) NOT NULL, "tipo_servico" "public"."servicos_tipo_servico_enum" NOT NULL DEFAULT 'VISTORIA', "custo" numeric(10,2) NOT NULL, "preco" numeric(10,2) NOT NULL, "integracao" "public"."servicos_integracao_enum" NOT NULL DEFAULT 'SEM_INTEGRACAO', "cliente_id" uuid, CONSTRAINT "PK_91c99670ea2115d2028a48c5e0e" PRIMARY KEY ("id")); COMMENT ON COLUMN "servicos"."custo" IS 'Valor em reais, quanto cobramos do nosso cliente'; COMMENT ON COLUMN "servicos"."preco" IS 'Valor em reais quanto nosso cliente cobra para o cliente final'`);
