...
export class CriaTabelasIniciais1738812628802 implements MigrationInterface {
    name = 'CriaTabelasIniciais1738812628802'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "opcoes_campo_nivel_risco_enum" AS ENUM('0', '1', '2', '3')`);
        await queryRunner.query(`CREATE TABLE "opcoes_campo" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "nome" character varying(100) NOT NULL, "alias" character varying NOT NULL, "eh_padrao" boolean NOT NULL DEFAULT false, "nivel_risco" "opcoes_campo_nivel_risco_enum" NOT NULL DEFAULT '0', "campo_id" uuid, CONSTRAINT "PK_6f0ce964eb3dc0b8434cb53296f" PRIMARY KEY ("id")); COMMENT ON COLUMN "opcoes_campo"."nome" IS 'Campo tipo slug para usara em referencias fixas'; COMMENT ON COLUMN "opcoes_campo"."alias" IS 'Campo exibido nas labels'; COMMENT ON COLUMN "opcoes_campo"."nivel_risco" IS 'Campo indica um coloração diferente para a opção'`);
        await queryRunner.query(`CREATE TYPE "bloco_imagens_tipo_veiculo_enum" AS ENUM('0', '1', '2', '3', '4', '5')`);
        await queryRunner.query(`CREATE TABLE "bloco_imagens" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "nome" character varying(75) NOT NULL, "imagem_caminho" character varying NOT NULL, "tipo_veiculo" "bloco_imagens_tipo_veiculo_enum" NOT NULL DEFAULT '0', "bloco_id" uuid, CONSTRAINT "PK_f50f5770103fa2ff013300431d1" PRIMARY KEY ("id")); COMMENT ON COLUMN "bloco_imagens"."imagem_caminho" IS 'Somente preenchido quando tipo bloco = imagem'`);
        ...
        await queryRunner.query(`CREATE TABLE "municipios" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "nome" character varying(150) NOT NULL, "estado_id" uuid, CONSTRAINT "PK_10d04b4b4e39ba40240b61e919d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "enderecos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "logradouro" character varying(200) NOT NULL, "numero" character varying(15) NOT NULL DEFAULT 'S/N', "complemento" character varying(150) NOT NULL, "cep" character varying(8) NOT NULL, "bairro" character varying(70) NOT NULL, "pessoa_id" uuid NOT NULL, "municipio_id" uuid, "tipo_endereco_id" uuid, CONSTRAINT "PK_208b05002dcdf7bfbad378dcac1" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "telefones" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "numero" character varying(15) NOT NULL, "pessoa_id" uuid NOT NULL, "tipo_telefone_id" uuid, CONSTRAINT "PK_fa0a7002d74f18ec1a13ca9a4f2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "clientes_finais" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "pessoa_id" uuid NOT NULL, CONSTRAINT "PK_19ba6772a777609b3e1b412b535" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "pessoa_tipo_documento_enum" AS ENUM('0', '1')`);
        await queryRunner.query(`CREATE TABLE "pessoa" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "apelido" character varying(150), "nome_formal" character varying(200) NOT NULL, "documento" character varying(18), "tipo_documento" "pessoa_tipo_documento_enum" NOT NULL DEFAULT '0', CONSTRAINT "PK_bb879ac36994545a5a917a09ba5" PRIMARY KEY ("id")); COMMENT ON COLUMN "pessoa"."apelido" IS 'Apelido para pf e nome fantasia para pj'; COMMENT ON COLUMN "pessoa"."nome_formal" IS 'Nome como no RG ou razão social para pj'; COMMENT ON COLUMN "pessoa"."documento" IS 'CPF ou CNPJ'`);
        await queryRunner.query(`CREATE TYPE "usuarios_perfil_enum" AS ENUM('0', '1', '2', '3')`);
        await queryRunner.query(`CREATE TABLE "usuarios" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "nome" character varying(150) NOT NULL, "email" character varying(150) NOT NULL, "perfil" "usuarios_perfil_enum" NOT NULL DEFAULT '3', "senha" character varying NOT NULL, "cliente_id" uuid, CONSTRAINT "UQ_446adfc18b35418aac32ae0b7b5" UNIQUE ("email"), CONSTRAINT "PK_d7281c63c176e152e4c531594a8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "clientes_vistoriadores_tipo_cliente_enum" AS ENUM('0', '1', '2')`);
        await queryRunner.query(`CREATE TABLE "clientes_vistoriadores" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "apelido" character varying(150) NOT NULL, "tipo_cliente" "clientes_vistoriadores_tipo_cliente_enum" NOT NULL DEFAULT '1', "link_logo" character varying(200), "termo_data_aceite" TIMESTAMP, "termo_usuario_id" character varying, "pessoa_id" uuid NOT NULL, "matriz_id" uuid, CONSTRAINT "PK_173f28e3366aa864ce93e7fda48" PRIMARY KEY ("id")); COMMENT ON COLUMN "clientes_vistoriadores"."apelido" IS 'nome para exibição em tela, é o msm valor do homônimo em pessoa'`);
        await queryRunner.query(`CREATE TYPE "servicos_tipo_servico_enum" AS ENUM('0', '1')`);
        await queryRunner.query(`CREATE TABLE "servicos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "nome" character varying(150) NOT NULL, "tipo_servico" "servicos_tipo_servico_enum" NOT NULL DEFAULT '0', "custo" numeric(10,2) NOT NULL, "preco" numeric(10,2) NOT NULL, "consulta" integer NOT NULL, "cliente_id" uuid, CONSTRAINT "PK_91c99670ea2115d2028a48c5e0e" PRIMARY KEY ("id")); COMMENT ON COLUMN "servicos"."custo" IS 'Valor em reais'; COMMENT ON COLUMN "servicos"."preco" IS 'Valor em reais'`);
        ...
        await queryRunner.query(`CREATE TYPE "ordem_servico_tipo_dado_consultado_enum" AS ENUM('0', '1')`);
        await queryRunner.query(`CREATE TYPE "ordem_servico_status_enum" AS ENUM('0', '1', '2', '3', '4', '5')`);
        await queryRunner.query(`CREATE TYPE "ordem_servico_parecer_vistoria_enum" AS ENUM('0', '1', '2', '3')`);
        await queryRunner.query(`CREATE TYPE "ordem_servico_tipo_os_enum" AS ENUM('0', '1')`);
        await queryRunner.query(`CREATE TABLE "ordem_servico" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "sequenciador" character varying(50) NOT NULL, "modelo_vistoria_snapshot" jsonb NOT NULL, "tipo_dado_consultado" "ordem_servico_tipo_dado_consultado_enum" NOT NULL DEFAULT '1', "dado_consultado" character varying(10), "comentario" character varying(200), "custo" numeric(10,2) NOT NULL, "preco" numeric(10,2) NOT NULL, "custo_zerado" boolean NOT NULL DEFAULT false, "status" "ordem_servico_status_enum" NOT NULL DEFAULT '0', "parecer_vistoria" "ordem_servico_parecer_vistoria_enum" NOT NULL DEFAULT '3', "tipo_os" "ordem_servico_tipo_os_enum" NOT NULL DEFAULT '1', "cliente_final_id" uuid, "cliente_id" uuid, "modelo_vistoria_id" uuid, "usuario_criador_id" uuid, "usuario_finalizador_id" uuid, CONSTRAINT "PK_dccd3809fd45d6946c6a999318c" PRIMARY KEY ("id")); COMMENT ON COLUMN "ordem_servico"."custo" IS 'Valor em reais'; COMMENT ON COLUMN "ordem_servico"."preco" IS 'Valor em reais'`);
        ...
        await queryRunner.query(`CREATE TABLE "servicos_modelos_vistoria" ("modelo_vistoria_id" uuid NOT NULL, "servico_id" uuid NOT NULL, CONSTRAINT "PK_e745edc2397129e72a4c080981d" PRIMARY KEY ("modelo_vistoria_id", "servico_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "enderecos" ADD CONSTRAINT "FK_165ce82c1d3abec9c2df4e5a5bc" FOREIGN KEY ("pessoa_id") REFERENCES "pessoa"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "telefones" ADD CONSTRAINT "FK_8b7c9a07d784e288f1a0232cb6c" FOREIGN KEY ("pessoa_id") REFERENCES "pessoa"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "clientes_finais" ADD CONSTRAINT "FK_c0d3ad07c13687881bd7210e3d3" FOREIGN KEY ("pessoa_id") REFERENCES "pessoa"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "usuarios" ADD CONSTRAINT "FK_5f4dc9b4cf1f7993658c5c22927" FOREIGN KEY ("cliente_id") REFERENCES "clientes_vistoriadores"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "clientes_vistoriadores" ADD CONSTRAINT "FK_2905c7d6c27bf9db3d7b33804ff" FOREIGN KEY ("pessoa_id") REFERENCES "pessoa"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "clientes_vistoriadores" ADD CONSTRAINT "FK_ffe40ae95be931ea950873cf587" FOREIGN KEY ("matriz_id") REFERENCES "clientes_vistoriadores"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "servicos" ADD CONSTRAINT "FK_a22c8a56173a760a78b2557c49d" FOREIGN KEY ("cliente_id") REFERENCES "clientes_vistoriadores"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "ordem_servico" ADD CONSTRAINT "FK_1e6fc9a2df0fe9c992559beb41f" FOREIGN KEY ("cliente_id") REFERENCES "clientes_vistoriadores"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "clientes_clientes_finais" ADD CONSTRAINT "FK_f0b62c662f831ee1aabbdd9043d" FOREIGN KEY ("cliente_final_id") REFERENCES "clientes_vistoriadores"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "usuarios_clientes" ADD CONSTRAINT "FK_47c33cfba10a273673d4aa2afdc" FOREIGN KEY ("cliente_id") REFERENCES "clientes_vistoriadores"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "servicos_modelos_vistoria" ADD CONSTRAINT "FK_687afc5e7e00d8fe002b3187443" FOREIGN KEY ("modelo_vistoria_id") REFERENCES "servicos"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "servicos_modelos_vistoria" ADD CONSTRAINT "FK_25ef5d27079674fe1028ca93cfb" FOREIGN KEY ("servico_id") REFERENCES "modelos_vistoria"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "clientes_vistoriadores" DROP CONSTRAINT "FK_ffe40ae95be931ea950873cf587"`);
        await queryRunner.query(`ALTER TABLE "clientes_vistoriadores" DROP CONSTRAINT "FK_2905c7d6c27bf9db3d7b33804ff"`);
        await queryRunner.query(`ALTER TABLE "usuarios" DROP CONSTRAINT "FK_5f4dc9b4cf1f7993658c5c22927"`);
        await queryRunner.query(`ALTER TABLE "clientes_finais" DROP CONSTRAINT "FK_c0d3ad07c13687881bd7210e3d3"`);
        await queryRunner.query(`ALTER TABLE "telefones" DROP CONSTRAINT "FK_9b1d4089c356d179c4f20114070"`);
        await queryRunner.query(`ALTER TABLE "telefones" DROP CONSTRAINT "FK_8b7c9a07d784e288f1a0232cb6c"`);
        ...
        await queryRunner.query(`ALTER TABLE "enderecos" DROP CONSTRAINT "FK_165ce82c1d3abec9c2df4e5a5bc"`);
        ...
        await queryRunner.query(`DROP INDEX "IDX_c64f6fc6cac27cfa46cf4c67ff"`);
        await queryRunner.query(`DROP INDEX "IDX_d682bbc9da514fff1e2edf97e5"`);
        await queryRunner.query(`DROP TABLE "modelos_vistoria_blocos"`);
        await queryRunner.query(`DROP INDEX "IDX_25ef5d27079674fe1028ca93cf"`);
        await queryRunner.query(`DROP INDEX "IDX_687afc5e7e00d8fe002b318744"`);
        await queryRunner.query(`DROP TABLE "servicos_modelos_vistoria"`);
        await queryRunner.query(`DROP INDEX "IDX_47c33cfba10a273673d4aa2afd"`);
        await queryRunner.query(`DROP INDEX "IDX_537eddd15bed67dcbbcbe97177"`);
        await queryRunner.query(`DROP TABLE "usuarios_clientes"`);
        await queryRunner.query(`DROP INDEX "IDX_f0b62c662f831ee1aabbdd9043"`);
        await queryRunner.query(`DROP INDEX "IDX_5f59a501b6a9b5d59d21061cba"`);
        await queryRunner.query(`DROP TABLE "clientes_clientes_finais"`);
        await queryRunner.query(`DROP TABLE "ordem_servico"`);
        await queryRunner.query(`DROP TYPE "ordem_servico_tipo_os_enum"`);
        await queryRunner.query(`DROP TYPE "ordem_servico_parecer_vistoria_enum"`);
        await queryRunner.query(`DROP TYPE "ordem_servico_status_enum"`);
        await queryRunner.query(`DROP TYPE "ordem_servico_tipo_dado_consultado_enum"`);
        await queryRunner.query(`DROP TABLE "modelos_vistoria"`);
        await queryRunner.query(`DROP TABLE "servicos"`);
        await queryRunner.query(`DROP TYPE "servicos_tipo_servico_enum"`);
        await queryRunner.query(`DROP TABLE "clientes_vistoriadores"`);
        await queryRunner.query(`DROP TYPE "clientes_vistoriadores_tipo_cliente_enum"`);
        await queryRunner.query(`DROP TABLE "usuarios"`);
        await queryRunner.query(`DROP TYPE "usuarios_perfil_enum"`);
        await queryRunner.query(`DROP TABLE "pessoa"`);
        await queryRunner.query(`DROP TYPE "pessoa_tipo_documento_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "blocos_tipo_bloco_enum"`);
        await queryRunner.query(`DROP TABLE "campos"`);
        await queryRunner.query(`DROP TYPE "campos_tipo_campo_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "bloco_imagens_tipo_veiculo_enum"`);
        await queryRunner.query(`DROP TABLE "opcoes_campo"`);
        await queryRunner.query(`DROP TYPE "opcoes_campo_nivel_risco_enum"`);
    }
