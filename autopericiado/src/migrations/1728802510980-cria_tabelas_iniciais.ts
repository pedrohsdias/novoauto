...
export class CriaTabelasIniciais1728802510980 implements MigrationInterface {
  name = 'CriaTabelasIniciais1728802510980';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "opcoes_campo" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "nome" character varying(100) NOT NULL, "alias" character varying NOT NULL, "coordenada_x_y" character varying(20), "eh_padrao" boolean NOT NULL DEFAULT false, "nivel_risco" "public"."opcoes_campo_nivel_risco_enum" NOT NULL DEFAULT 'padrao', "campo_id" uuid, CONSTRAINT "PK_6f0ce964eb3dc0b8434cb53296f" PRIMARY KEY ("id")); COMMENT ON COLUMN "opcoes_campo"."alias" IS 'Campo tipo slug para usara em referencias especificas'; COMMENT ON COLUMN "opcoes_campo"."coordenada_x_y" IS 'Campo preenchido quando bloco tipo imagem, indicando onde marcar na imagem'; COMMENT ON COLUMN "opcoes_campo"."nivel_risco" IS 'Campo indica um coloração diferente para a opção'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "campos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "nome" character varying(100) NOT NULL, "alias" character varying(100) NOT NULL, "tipo_campo" "public"."campos_tipo_campo_enum" NOT NULL DEFAULT 'input', "qtd_selecionado" integer NOT NULL DEFAULT '0', "tem_observacao" boolean NOT NULL DEFAULT false, "bloco_id" uuid, CONSTRAINT "PK_354272e954a46096a9392ee3c98" PRIMARY KEY ("id")); COMMENT ON COLUMN "campos"."alias" IS 'Campo tipo slug para usara em referencias especificas'; COMMENT ON COLUMN "campos"."qtd_selecionado" IS '0 = campo opcional, 1 = campo obrigatorio, 2=campo multivalorado'; COMMENT ON COLUMN "campos"."tem_observacao" IS 'Caso alem do valor o campo permita observação, tipo item de avaliacao'`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."blocos_tipo_bloco_enum" AS ENUM('padrao', 'imagem', 'leitura', 'upload')`,
    );
    await queryRunner.query(
      `CREATE TABLE "blocos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "nome" character varying(75) NOT NULL, "fontAwesomeIcon" character varying(30), "imagem_caminho" character varying, "tipo_bloco" "public"."blocos_tipo_bloco_enum" NOT NULL DEFAULT 'padrao', CONSTRAINT "PK_bfc88d6483d37c14c8f2798af48" PRIMARY KEY ("id")); COMMENT ON COLUMN "blocos"."imagem_caminho" IS 'Somente preenchido quando tipo bloco = imagem'`,
    );
    await queryRunner.query(
      `CREATE TABLE "franquiadores" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "apelido" character varying(150) NOT NULL, "link_logo" character varying(200) NOT NULL, "termo_data_aceite" TIMESTAMP, "termo_usuario_id" character varying, "pessoa_id" uuid, CONSTRAINT "PK_8795ac9427beafb83090ceefbca" PRIMARY KEY ("id")); COMMENT ON COLUMN "franquiadores"."apelido" IS 'nome para exibição em tela, é o msm valor do homônimo em pessoa'`,
    );
    await queryRunner.query(
      `CREATE TABLE "estados" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "nome" character varying(70) NOT NULL, "uf" character varying(2) NOT NULL, CONSTRAINT "PK_3d9a9f2658d5086012f27924d30" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "municipios" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "nome" character varying(150) NOT NULL, "estado_id" uuid, CONSTRAINT "PK_10d04b4b4e39ba40240b61e919d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tipos_endereco" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "descricao" character varying(30) NOT NULL, CONSTRAINT "PK_73f95ea7e39f8657ea38afe9d0b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "enderecos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "logradouro" character varying(200) NOT NULL, "numero" character varying(15) NOT NULL DEFAULT 'S/N', "complemento" character varying(150) NOT NULL, "cep" character varying(8) NOT NULL, "bairro" character varying(70) NOT NULL, "pessoa_id" uuid, "municipio_id" uuid, "tipo_endereco_id" uuid, CONSTRAINT "PK_208b05002dcdf7bfbad378dcac1" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tipos_telefone" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "descricao" character varying(30) NOT NULL, CONSTRAINT "PK_05e2b75fa8af46587a52f6bc7a8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "telefones" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "numero" character varying(15) NOT NULL, "pessoa_id" uuid, "tipo_telefone_id" uuid, CONSTRAINT "PK_fa0a7002d74f18ec1a13ca9a4f2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "ordem_servico" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "sequenciador" character varying(50) NOT NULL, "modelo_vistoria_snapshot" jsonb NOT NULL, "tipo_dado_consultado" "public"."ordem_servico_tipo_dado_consultado_enum" NOT NULL DEFAULT 'PLACA', "dado_consultado" character varying(10), "comentario" character varying(200), "custo" numeric(10,2) NOT NULL, "preco" numeric(10,2) NOT NULL, "status" "public"."ordem_servico_status_enum" NOT NULL DEFAULT 'AGENDADO', "parecer_vistoria" "public"."ordem_servico_parecer_vistoria_enum" NOT NULL DEFAULT 'FINALIZAR SEM PARECER', "tipo_os" "public"."ordem_servico_tipo_os_enum" NOT NULL DEFAULT 'VISTORIA', "custo_zerado" boolean NOT NULL DEFAULT false, "cliente_id" uuid, "unidade_id" uuid, "modelo_vistoria_id" uuid, CONSTRAINT "PK_dccd3809fd45d6946c6a999318c" PRIMARY KEY ("id")); COMMENT ON COLUMN "ordem_servico"."custo" IS 'Valor em reais'; COMMENT ON COLUMN "ordem_servico"."preco" IS 'Valor em reais'`,
    );
    await queryRunner.query(
      `CREATE TABLE "clientes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "unidade_id" uuid, "pessoa_id" uuid, CONSTRAINT "PK_d76bf3571d906e4e86470482c08" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."pessoa_tipo_documento_enum" AS ENUM('PJ', 'PF')`,
    );
    await queryRunner.query(
      `CREATE TABLE "pessoa" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "apelido" character varying(150), "nome_formal" character varying(200) NOT NULL, "documento" character varying(18), "tipo_documento" "public"."pessoa_tipo_documento_enum" NOT NULL DEFAULT 'PJ', CONSTRAINT "PK_bb879ac36994545a5a917a09ba5" PRIMARY KEY ("id")); COMMENT ON COLUMN "pessoa"."apelido" IS 'Apelido para pf e nome fantasia para pj'; COMMENT ON COLUMN "pessoa"."nome_formal" IS 'Nome como no RG ou razão social para pj'; COMMENT ON COLUMN "pessoa"."documento" IS 'CPF ou CNPJ'`,
    );
    await queryRunner.query(
      `CREATE TABLE "unidades" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "apelido" character varying(200) NOT NULL, "franquiador_id" uuid, "pessoa_id" uuid, CONSTRAINT "PK_3e728a664b48bbd90a355065233" PRIMARY KEY ("id")); COMMENT ON COLUMN "unidades"."apelido" IS 'nome para exibição em tela, é o msm valor do homônimo em pessoa'`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."servicos_tipo_servico_enum" AS ENUM('VISTORIA', 'CONSULTA')`,
    );
    await queryRunner.query(
      `CREATE TABLE "servicos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "nome" character varying(150) NOT NULL, "tipo_servico" "public"."servicos_tipo_servico_enum" NOT NULL DEFAULT 'VISTORIA', "custo" numeric(10,2) NOT NULL, "preco" numeric(10,2) NOT NULL, "consulta" integer NOT NULL, "unidade_id" uuid, CONSTRAINT "PK_91c99670ea2115d2028a48c5e0e" PRIMARY KEY ("id")); COMMENT ON COLUMN "servicos"."custo" IS 'Valor em reais'; COMMENT ON COLUMN "servicos"."preco" IS 'Valor em reais'`,
    );
    await queryRunner.query(
      `CREATE TABLE "modelos_vistoria" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "nome" character varying(100) NOT NULL, CONSTRAINT "PK_1560c580b319f1ba971e419ea76" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "servicos_modelos_vistoria" ("modelo_vistoria_id" uuid NOT NULL, "servico_id" uuid NOT NULL, CONSTRAINT "PK_e745edc2397129e72a4c080981d" PRIMARY KEY ("modelo_vistoria_id", "servico_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "modelos_vistoria_blocos" ("modelo_vistoria_id" uuid NOT NULL, "bloco_id" uuid NOT NULL, CONSTRAINT "PK_1f14fb8b7bc8b985a93da0c1e64" PRIMARY KEY ("modelo_vistoria_id", "bloco_id"))`,
    );
    await queryRunner.query(
